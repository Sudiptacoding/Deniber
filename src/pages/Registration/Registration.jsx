  ...
  return (
    <div className="max-w-md p-6 mx-auto mt-10 bg-white shadow-lg rounded-3xl">
      ...
      <div className="flex items-center mb-4">
        <select className="p-3 mt-2 mb-2  border-2 border-r-0 border-[#D0D1D4] rounded-l-lg text-sm bg-white focus:outline-none">
      ...
      {/* Login Button */}
      <button className="w-full px-4 py-2 mb-4 font-extrabold text-white rounded-lg bg-primary">
        Registration
      </button>
