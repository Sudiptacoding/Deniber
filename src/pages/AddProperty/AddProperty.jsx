...
const AddProperty = () => {
    ...
    const [card1SelectColor, setCard1SelectColor] = useState(null)
    const [card2SelectColor, setCard2SelectColor] = useState(null)
    ...
    // Step 2 function
    const handleCategorySelect = (i, item) => {
        setStep2Value(item)
                ...
                <div className="flex-1 pl-5 ">
                    ...
                    <div className={`flex items-center justify-between mt-40 ${activeStep === 7 ? 'hidden' : ''}`}>
                        ...
                        >
                            Next
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <path d="M6 3.33335L10.6667 8.00002L6 12.6667" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </button>
                    </div>
                </div>
