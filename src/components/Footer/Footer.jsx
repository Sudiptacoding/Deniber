...
const Footer = () => {
    ...
    console.log(currentPath === '/propertydetails')


    return (
        <>
            {
                currentPath === '/propertydetails' || currentPath === '/searchresult' ? <div className='py-14 bg-[#22252B]'>
                    <footer className="p-10 px-5 footer text-base-content 2xl:px-80 ">
                        <asde>
                            ...
                            <p class="py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">OurStudio is a digital agency UI / UX Design and Website Development located in Ohio, United States of America?</p>
                        </asde>
                        <nav>
                        ...
                        <nav>
                            <a href="javascript:;" class="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-yellow-800 focus-within:outline-0 focus-within:text-yellow-800 flex items-center gap-4"><span><MdOutlineLocationOn /></span><span>8819 Ohio St. South Gate, CA 90280</span></a>
                            <a href="javascript:;" class="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-yellow-800 focus-within:outline-0 focus-within:text-yellow-800 flex items-center gap-4"><span><MdOutlineMail /></span><span>Ourstudio@hello.com</span></a>
                            <a href="javascript:;" class="text-base font-normal max-lg:text-center text-gray-600 whitespace-nowrap transition-all duration-300 hover:text-yellow-800 focus-within:outline-0 focus-within:text-yellow-800 flex items-center gap-4"><span><MdOutlinePhone /></span><span>+1 386-688-3295</span></a>
